...
class SendMoneyMandiri extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Container(
              // autogroupwa8cPpg (A1iFMaejLSGu9KqAuNwA8c)
              padding:
                  ...
                  Container(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        height: 40 * fem,
                        child: Image.asset(
                          'assets/page-1/images/image-46-9Lp.png',
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
            ...
            Container(
              // autogroupzpmajXA (A1iFueZdb78iaGmHKrzpMa)
              padding:
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    // autogroupd5wumik (A1iFV5SEsjeLYUuXzMD5WU)
                    margin: EdgeInsets.fromLTRB(
                        16 * fem, 0 * fem, 161 * fem, 36 * fem),
                    width: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Container(
                          ...
                          height: 14.51 * fem,
                          child: Image.asset(
                            'assets/page-1/images/image-65-sTA.png',
                            fit: BoxFit.cover,
                          ),
                        ),
                        Text(
                          // bankmandiricDa (35:755)
                          'Bank Mandiri',
                          style: SafeGoogleFont(
                            'Inter',
                            fontSize: 16 * ffem,
