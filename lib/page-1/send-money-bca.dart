...
class SendMoneyBca extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Container(
              // autogroupa6miqJC (A1iCXkC49p995FTv27A6mi)
              padding:
                  EdgeInsets.fromLTRB(15 * fem, 50 * fem, 90 * fem, 10 * fem),
                  ...
                  Container(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        height: 40 * fem,
                        child: Image.asset(
                          'assets/page-1/images/image-46-fBi.png',
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
            ...
            Container(
              // autogroupqlpuMfr (A1iD7PteoCgvn3MiyvqLpU)
              padding:
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    // autogroup7dbsQu2 (A1iCfVU9YVMdFeNksi7DbS)
                    margin: EdgeInsets.fromLTRB(
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          height: 15.92 * fem,
                          child: Image.asset(
                            'assets/page-1/images/image-68-RSC.png',
                            fit: BoxFit.cover,
                          ),
                        ),
                        Text(
